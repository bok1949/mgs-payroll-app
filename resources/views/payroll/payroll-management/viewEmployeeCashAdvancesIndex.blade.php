    ...
    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('payroll-dashboard') }}">Dashboard</a>
            </li>
            <li class="breadcrumb-item">
            ...
            <li class="breadcrumb-item active" aria-current="page">View Employee cash advances</li>
        </ol>
    </nav>
</div>
@endsection
...
<section class="section">
    <div class="row ">
        <div class="col-12 col-md-12">
            @livewire('payroll.payroll-management.view-employee-cash-advances-index', ['empId' => $employeeId])
        </div>
    </div>
</section>
@endsection
