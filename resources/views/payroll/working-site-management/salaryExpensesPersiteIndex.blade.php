...
<div class="col-12 col-md-6 order-md-1 order-last">
    <h3>List of Working Site Salary Expenses</h3>
</div>
<div class="col-12 col-md-6 order-md-2 order-first">
    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('payroll-dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Working Site Salary Expenses</li>
        </ol>
    </nav>
</div>
@endsection
...
<section class="section">
    <div class="row ">
        <div class="col-12 col-md-12">
            @livewire('payroll.working-site-management.working-site-salary-expenses-index')
        </div>
    </div>
</section>
@endsection
